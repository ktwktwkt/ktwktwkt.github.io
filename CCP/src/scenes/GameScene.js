...
export default class GameScene extends Phaser.Scene {
    ...
    createEnemies() {
        ...
        const enemyTypes = ['normal', 'fast', 'ranged', 'tank', 'zigzag', 'circler', 'charger', 'sniper', 'kamikaze', 'teleporter', 'splitter']; // 모든 적 타입 추가
    ...
    spawnWaveEnemies() {
        ...
        const types = ['normal', 'fast', 'ranged', 'tank', 'zigzag', 'circler', 'charger', 'sniper', 'kamikaze', 'teleporter', 'splitter'];
    ...
    showCriticalEffect(x, y) {
        ...
        // 약한 화면 흔들림 (강도 더 줄임)
        this.cameras.main.shake(50, 0.001);  // 더 약하게 조정
    ...
    handleExplosion(x, y, damage, radius) {
        ...
        // 화면 흔들림
        this.cameras.main.shake(100, 0.003);  // 강도 줄임
    }
